                ...
                <View style={{ paddingVertical: 10, flexDirection: 'row' }}>
                  ...
                  <View>
                    <TextInput
                      ...
                      style={{ fontSize: 20, paddingHorizontal: 10, minWidth:"95%", borderBottomWidth: 1, borderColor:'#000'}}
                  ...
                  <View style={styles.input}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                      <TextInput
                        ...
                        ref="1"
                        keyboardType="numeric"
                        style={{ fontSize: 20, flexGrow: 2, height: 45, alignSelf: 'flex-start', width: '45%', borderBottomWidth: 1, borderColor:'#000' }}
                        underlineColorAndroid='rgba(0,0,0,0)'
                        placeholder="MM"
                        maxLength={2}
                      ...
                      <TextInput
                        ...
                        ref="2"
                        keyboardType="numeric"
                        style={{ fontSize: 20, flexGrow: 2, height: 45, alignSelf: 'flex-end', width: '45%', textAlign: 'right', borderBottomWidth: 1, borderColor:'#000' }}
                      underlineColorAndroid='rgba(0,0,0,0)'
                      placeholder="YY"
                        maxLength={2}
                ...
                <View style={{ flexGrow: 1, paddingLeft: 10, maxWidth: 150  }}>
                  ...
                  <View style={styles.input}>
                    <TextInput
                      ...
                      underlineColorAndroid='rgba(0,0,0,0)'
                      style={{ height: 45, width: '100%', fontSize: 20, borderBottomWidth: 1, borderColor:'#000' }}
